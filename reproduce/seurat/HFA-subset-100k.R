...
library(glue)
# ================================================
# HumanFetal 40k + 60k dataset
# ================================================
library(Matrix)
read_dir = glue("/home/yxh/data/HumanFetal_100k/")
...
write.csv(atac.pred, file='/home/yxh/gitrepo/multi-omics/seurat/outputs/HumanFetal_100k.csv', quote=F, row.names=T)

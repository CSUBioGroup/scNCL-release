...
library(glue)
# ================================================
# HumanFetal 20k + 30k dataset
# ================================================
library(Matrix)
read_dir = glue("/home/yxh/data/HumanFetal_50k/")
...
# mcasubset.atac.pred <- TransferData(anchorset = mcasubset.anchors, refdata = mcasubset.rna$cell_type,
#     weight.reduction = mcasubset.atac[["lsi"]], dims = 2:30)
...
write.csv(atac.pred, file='/home/yxh/gitrepo/multi-omics/seurat/outputs/HumanFetal_50k.csv', quote=F, row.names=T)
